    ...
    Trivia Bot Wdpp3l
    =================
    Classic complete game reimagined as a single-file Python script.
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Classic complete game reimagined as a single-file Python script.")
